...
public class MovieUpcomingLoader extends AsyncTaskLoader<List<MovieModel>> {
    ...
    public List<MovieModel> loadInBackground() {
        ...
        String url = AppConstant.MOVIE_UPCOMING_URL + "?api_key=" + BuildConfig.THE_MOVIE_DB_API_KEY_DEBUG;
