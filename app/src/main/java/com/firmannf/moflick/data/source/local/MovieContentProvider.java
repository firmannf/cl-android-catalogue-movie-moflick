...
import static com.firmannf.moflick.data.source.local.DatabaseContract.AUTHORITY;
...
/**
 * Created by codelabs on 26/07/18.
 */

public class MovieContentProvider extends ContentProvider {
    private static final int MOVIE_ALL = 1;
    private static final int MOVIE_BY_ID = 2;

    private static final UriMatcher sUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);

    static {
        sUriMatcher.addURI(AUTHORITY, TABLE_FAVORITE_MOVIE, MOVIE_ALL);
